...
<template>
  <div class="muscle-groups-container">
    <div class="muscle-groups-names-wrapper">
      <div class="names-group primary-color">
        <span class="muscle-group-type">Primarna grupa mišića</span>
        <span> {{ props.activeMuscleGroups.primary.name }}</span>
      </div>
      <div v-if="props.activeMuscleGroups.secondary.length" class="names-group secondary-color">
        <span class="muscle-group-type">Sekundarne grupe mišića</span>
        <span v-for="mg in props.activeMuscleGroups.secondary" :key="mg.id"> {{ mg.name }}</span>
      </div>
    </div>
